...
echo "==============================================="
echo "BELI VPS ALIBABA 40K KE STORE : @candrapn"
echo "==============================================="
sleep 5
...
read -p "Enter your desired username [default: admin]: " CUSTOM_USER
CUSTOM_USER=${CUSTOM_USER:-admin}

read -p "Enter your desired password [default: admin123]: " PASSWORD
PASSWORD=${PASSWORD:-admin123}

echo "Using username: $CUSTOM_USER"
...
echo "Chromium sudah berhasil diinstall !"
